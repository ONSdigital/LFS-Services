...
def p1(uresmc):
    if (uresmc in (8,9)) then do
        if uresmc == 9 return 11
        elseif (ualad99 == "  aa") return 8
        elseif (ualad99 in ("  ag","  au","  aw","  be","  bk")) then do ;
...
def regproc(ioutcome, lad96, wad96, uresmc, a, b, c, d):
    ioutcome != 3: return -9
    ladwad = lad96.strip() + wad96.strip();
    if not (a == 4 or a == -9 or a == -8):
        return p1(uresmc)


if ioutcome^=3 then do;
 %macro regproc(a,b,c,d) ;
   regwp=(-9) ;
   LADWAD=strip(lad96)||strip(wad96);
   if ((&a. eq 4) or (&a. eq -9 or &a. eq -8)) then do ;
      if (&d. eq 999997) then regwp =(23) ;
      ELSE IF (&c. in ("  CH","  CJ","  CK","  CL","  CM")) THEN REGWP=(1) ;
      ELSE IF (&c. in ("  EB","  EC","  EE","  EF","  EH","16UB","16UC","16UD","16UE","16UF","16UG","20UB","20UD",
                                  "20UE","20UF","20UG","20UH","20UJ","35UB","35UC","35UD","35UE","35UF","35UG")) THEN REGWP=(2) ;
      ELSE IF (&c. in ("  CC","  CE","  CF","  CG")) THEN REGWP=(3) ;
      ELSE IF (&c. in ("  CX","  CY","  CZ","  DA","  DB")) THEN REGWP=(4) ;
      ELSE IF (&c. in ("  FA","  FB","  FC","  FD","  FF","36UB","36UC","36UD","36UE","36UF","36UG","36UH")) THEN REGWP=(5) ;
      ELSE IF (&c. in ("  FK","  FN","  FP","  FY","17UB","17UC","17UD","17UF","17UG","17UH","17UJ","17UK",
                                  "31UB","31UC","31UD","31UE","31UG","31UH","31UJ","32UB","32UC","32UD","32UE","32UF",
                                  "32UG","32UH","34UB","34UC","34UD","34UE","34UF","34UG","34UH","37UB","37UC","37UD",
                                  "37UE","37UF","37UG","37UJ")) then REGWP=(6) ;
      ELSE IF (&c. in ("  JA","12UB","12UC","12UD","12UE","12UG","33UB","33UC","33UD","33UE","33UF","33UG","33UH",
                                  "42UB","42UC","42UD","42UE","42UF","42UG","42UH")) THEN REGWP =(7) ;
