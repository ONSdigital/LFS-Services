...
func (s Postgres) GetIdsByYear(year types.Year) ([]types.YearID, error) {
	// Variables
...
func (s Postgres) GetIdsByQuarter(year types.Year, quarter types.Quarter) ([]types.QuarterID, error) {
	// Variables
...
func (s Postgres) GetIdsByMonth(year types.Year, month types.Month) ([]types.MonthID, error) {
	// GB and NI Variables
